...
>>> arc.sigmffiles[0].shape
(15379532,)
>>> arc.sigmffiles[0].ndim
1
>>> arc.sigmffiles[0][:10]
...
```python
>>> arc.sigmffiles[0].get_global_field(sigmf.SigMFFile.DATATYPE_KEY)
'ci16_le'

>>> arc.sigmffiles[0]._memmap.dtype
dtype('int16')

>>> arc.sigmffiles[0]._return_type
'<c8'
```
